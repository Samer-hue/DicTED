...
def get_args():
  ...
  parser.add_argument('-d', '--data', type=str, help='data sources to use, try wikipedia or reddit',
            choices=['wikipedia', 'reddit', 'socialevolve', 'uci', 'enron', 'socialevolve_1month', 'socialevolve_2weeks', 'ubuntu', 'sx-superuser', 'wiki-talk-temporal', 'mooc', 'sx-superuser-a2q'],
            default='wikipedia')
  ...
  parser.add_argument('--weight1', type=float, default=0.1, help='The weight of the new point embedding')
  #parser.add_argument('--model', type=str, default="deepwalk", help='The model we use', choices=['deepwalk', 'node2vec','gae', 'MVGRL', 'SDCN', 'TGN', 'TREND'])
  parser.add_argument('--a1', type=float, default=0.1, help='The weight of gae')
  parser.add_argument('--a2', type=float, default=0.4, help='The weight of sdcn')
  parser.add_argument('--a3', type=float, default=0.3, help='The weight of tgn')
